...
from v22b_dataset_loader import FACTOR_AXIS_NAMES, ConversationGroup, PairExample, bundle_from_groups, load_all_groups
from v22b_metrics import append_jsonl, write_json
...
from v22b_policy_features import PolicyFeatureBuilder, build_policy_features
from v22b_training_core import (
...
def aggregate_reports(reports: list[dict[str, Any]]) -> dict[str, Any]:
    keys = [
        ...
        "bad_top3_rate",
        "bad_top5_rate",
        "bad_exposed_top1_rate",
        "bad_exposed_top3_rate",
        "bad_exposed_top5_rate",
        "active_bad_top1_rate",
        "active_bad_top3_rate",
        "active_bad_top5_rate",
        "no_tool_suppressed_bad_top3_rate",
        "no_tool_suppressed_bad_top5_rate",
        "agent_bad_top3_rate",
        "top3_label_mean",
        "top5_label_mean",
        "top3_label_max",
        ...
        "active_tool_top1",
        "active_tool_topk",
        "activation_action_accuracy",
        "ask_confirm_recall",
        "ask_confirm_precision",
        "ask_confirm_candidate_groups",
        "activation_groups",
        "no_tool_candidate_groups",
