...
SOURCE_DIR = Path(__file__).resolve().parents[3] / "modules" / "v22b_relevance_scorer" / "source"
if str(SOURCE_DIR) not in sys.path:
    sys.path.insert(0, str(SOURCE_DIR))

from v22b_dataset_loader import PairExample  # noqa: E402
from v22b_policy_features import ACTION_CONSENT_B_FEATURES, ACTION_CONSENT_FEATURES, PolicyFeatureBuilder  # noqa: E402
